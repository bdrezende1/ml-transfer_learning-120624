# -*- coding: utf-8 -*-
"""ml-transfer-learning-01.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/136amirghB41u1kx5YZXZ5TW3FDDwwCJz
...
def remove_non_jpg_files(directory):
  """Removes all files from a directory that are not JPG images.
...
# Iterate through the subdirectories and remove non-jpg files
for category in categories:
    remove_non_jpg_files(category)

# prompt: remova os arquivos PetImages/Dog/11702.jpg e PetImages/Cat/666.jpg com problema

# Define the paths to the files to be removed
file1_path = os.path.join(root, 'Dog', '11702.jpg')
file2_path = os.path.join(root, 'Cat', '666.jpg')
...
# prompt: contar quantos arquivos tem para cada classe
